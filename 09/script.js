...
let krovla=true;
function type0(){
    let reload = confirm("Все данные которые вы ввели будут удалены. Вы уверены что хотите вернуться назад?");
    if( reload ){
        location.reload()
    };
}
    ...
    if (a && num!=4){
        ...
        if (num==2){
            ...
            if(selecttext1==""){
                ...
                let pred101 = document.querySelector(".pred10f");
                pred101.className="block-pred2 pred10f"
                let pred102 = document.querySelector(".pred11f");
                pred102.className="block-pred4 pred11f"
                let pred103 = document.querySelector(".pred12f");
                pred103.className="block-pred4 pred12f"
                ...
                let pred101 = document.querySelector(".pred10f");
                pred101.className="block-pred4 pred10f"
                let pred102 = document.querySelector(".pred11f");
                pred102.className="block-pred2 pred11f"
                let pred103 = document.querySelector(".pred12f");
                pred103.className="block-pred4 pred12f"
                ...
                pred102.className="block-pred4 pred11f"
                let pred103 = document.querySelector(".pred12f");
                pred103.className="block-pred2 pred12f"
                let pred9 = document.querySelector(".pred9f");
                pred9.style.display="none";
                let pred10 = document.querySelector(".pred10f div");
                let div = document.createElement('div');
